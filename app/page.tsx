  ...
  return (
    <main>
      ...
      <footer className="footer shell" id="contact">
        <div><a className="brand brandMark footerBrand" href="#top"><BrandLogo /></a><p>We build boring products that solve real problems.</p><div className="footerContact"><a href="mailto:info@theboringproduct.com">info@theboringproduct.com</a><span>4202 Gnarl Dr, Austin, TX 78731</span><a href="https://x.com/TheBoringProduct" target="_blank" rel="noreferrer">X / @TheBoringProduct</a></div></div>
