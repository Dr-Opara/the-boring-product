...
const products = [
  ...
  {name:"LocalBiz.lol",category:"Local Business / Advertising",description:"A local business discovery and sponsored-ranking platform where businesses compete for visibility through transparent placement bids.",href:"/products/localbiz"}
];
