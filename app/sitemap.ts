...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: "https://theboringproduct.com/products/processpilot-technologies", changeFrequency: "weekly", priority: 0.8 },
    { url: "https://theboringproduct.com/contracts", changeFrequency: "weekly", priority: 0.9 },
    { url: "https://theboringproduct.com/contracts/client-engagements", changeFrequency: "weekly", priority: 0.8 },
